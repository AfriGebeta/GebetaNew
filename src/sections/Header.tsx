...
export default function Header() {
    return (
        <Container>
            <div className="relative w-full flex flex-col items-center mt-[120px]">
                <h1 className="max-w-xl text-[40px] md:text-[48px] text-[#1B1E2B] dark:text-white text-center leading-60">Location
                    Solutions,
                    Simplified.</h1>
