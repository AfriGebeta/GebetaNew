            ...
            <div>
                ...
                <section className="mb-10">
                    ...
                    <p className="text-md text-gray-600 dark:text-gray-400 mb-6">
                        Please read these Terms and Conditions carefully before using the Gebeta Map API operated by Gebeta Software Private Limited Company.
                        By using this website, you are deemed to have read and agreed to the following terms and conditions.
                    </p>
                </section>

                <section className="mb-10">
                    <h2 className="text-3xl font-semibold text-[#1B1E2B] dark:text-white mb-4">Privacy Statement</h2>
                    <p className="text-md text-gray-600 dark:text-gray-400 mb-6">
                ...
                <section className="mb-10">
                    <h2 className="text-3xl font-semibold text-[#1B1E2B] dark:text-white mb-4">Links to This Website</h2>
                    <p className="text-md text-gray-600 dark:text-gray-400 mb-6">
                ...
                <section className="mb-10">
                    <h2 className="text-3xl font-semibold text-[#1B1E2B] dark:text-white mb-4">Links from This Website</h2>
                    <p className="text-md text-gray-600 dark:text-gray-400 mb-6">
                ...
                <section className="mb-10">
                    <h2 className="text-3xl font-semibold text-[#1B1E2B] dark:text-white mb-4">Copyright Notice</h2>
                    <p className="text-md text-gray-600 dark:text-gray-400 mb-6">
                ...
                <section className="mb-10">
                    <h2 className="text-3xl font-semibold text-[#1B1E2B] dark:text-white mb-4">Communication</h2>
                    <p className="text-md text-gray-600 dark:text-gray-400 mb-6">
                        We have e-mail addresses for you to contact us. These, & other contact information, can be found on our Contact Us link on our website or via Company literature or via the Company’s stated telephone, facsimile or mobile telephone numbers.
                    </p>
                </section>

                <section className="mb-10">
                    <h2 className="text-3xl font-semibold text-[#1B1E2B] dark:text-white mb-4">Force Majeure</h2>
                    <p className="text-md text-gray-600 dark:text-gray-400 mb-6">
                ...
                <section className="mb-10">
                    <h2 className="text-3xl font-semibold text-[#1B1E2B] dark:text-white mb-4">Governing Law</h2>
                    <p className="text-md text-gray-600 dark:text-gray-400 mb-6">
                ...
                <section className="mb-10">
                    <h2 className="text-3xl font-semibold text-[#1B1E2B] dark:text-white mb-4">Notification of Changes</h2>
                    <p className="text-md text-gray-600 dark:text-gray-400 mb-6">
