...
export default function TSS() {
    return (
        <div className="min-h-screen">
            <h2 className="text-[#1B1E2B] dark:text-white text-[40px] text-center leading-50 mt-[40px]">Route Optimization</h2>
            <p className="text-[#62677F] text-[20px] text-center leading-25 mt-[32px]">Precise address and places search for business intelligence, ecommerce, and logistics</p>
            <div className="flex justify-center items-center gap-[32px] mt-[44px]">
                <Link
                    ...
                    for free</Link>
                <Link
                    href="https://www.docs.gebetamaps.app/tss"
