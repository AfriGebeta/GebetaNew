        ...
        <Container>
            <div className="mt-[104px] flex flex-col items-center">
                <h4 className="text-[#979BAA] text-[12px] tracking-20 leading-15 font-bold uppercase text-center">This
                    is GebetaMaps</h4>
                <h2 className="text-[#1B1E2B] text-[40px] text-center leading-50 mt-[10px]">All in One Location
                    Solution</h2>
                ...
                <div className="flex items-center gap-[40px] mt-[48px]">
                    <div className="flex items-center gap-[16px]">
                        <div
                            className="w-[72px] h-[72px] flex justify-center items-center bg-[#FFF7E8] rounded-[16px]">
