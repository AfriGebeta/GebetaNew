...
export default function VideoCarousel() {
    ...
    return (
        <div className="flex flex-col gap-8 justify-center items-center w-full mt-[48px]">
            <div className="relative w-full h-[400px] overflow-hidden">
                {videos.map((video, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={`absolute top-1/2 left-1/2 w-[60%] aspect-video transition-all duration-500 ease-in-out`}
                            style={{
